package com.welldo.spring.spring4aop.a3;
...
public class LoggingAspect {
    ...
    @Before("execution(public * com.welldo.spring.spring4aop.a3.service.UserService.*(..))")//不限返回值,不限参数个数
    ...
    @Around("execution(public * com.welldo.spring.spring4aop.a3.service.MailService.*(..))")
